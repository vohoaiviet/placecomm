 ...
 * @author Tuan Nguyen
 */
public class PlayMp3Agent extends Agent {
        ...
        Iterator it = getAID().getAllAddresses();
            ...
            Behaviour b = new OneShotBehaviour(this) {
                public void action() {
                    ...
                    String sFilename="http://www.tuannguyen.mobi/IWillSurvive.mp3";
                    System.out.println("This is a test, automatic load file:\n"+sFilename);
                        try{
                        PlayThisFile(sFilename);
                        }catch(Exception e){
                            Logger.getLogger(PlayMp3Agent.class.getName()).log(Level.SEVERE, null, e);
                        }
    ...
    void PlayThisFile(String sFilename) {
        ...
        // "C:\Program Files\VideoLAN\VLC\vlc.exe" %1 %2 %3
        
        String cmdline = "vlc.bat "+sFilename;
        ...
        try {
            ...
            Thread.sleep(5000);
            pr = rt.exec("taskkill /IM vlc.exe");
            System.out.println("Then killed! ");
        } catch (Exception ex) {
          Logger.getLogger(PlayMp3Agent.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

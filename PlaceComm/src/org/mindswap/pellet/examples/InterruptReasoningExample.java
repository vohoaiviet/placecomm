...
public class InterruptReasoningExample {
	...
	public static class WINE {
		public static final String		NS				=
                "http://www.tuannguyen.mobi/ontologies/wine#";
	...
	public InterruptReasoningExample() {
        ...
        timers.createTimer( "complete" ).setTimeout( 5000000 );
		timers.createTimer( "classify" ).setTimeout( 5000000 );
		timers.createTimer( "realize" ).setTimeout( 5000000 );
	}

...
public class PlaceCommOntology extends jade.content.onto.Ontology  {
  ...
  */
  private PlaceCommOntology(){ 
    ...
    add(timeInstanceSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.TimeInstance"));
    PredicateSchema pbvcSchema = new PredicateSchema(PBVC);
    add(pbvcSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.PBVC"));
    PredicateSchema serviceSchema = new PredicateSchema(SERVICE);
    add(serviceSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.Service"));
    PredicateSchema hasQuerySchema = new PredicateSchema(HASQUERY);
    add(hasQuerySchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.HasQuery"));
    PredicateSchema contextSchema = new PredicateSchema(CONTEXT);
    add(contextSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.Context"));
    PredicateSchema postalAddressSchema = new PredicateSchema(POSTALADDRESS);
    add(postalAddressSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.PostalAddress"));
    PredicateSchema deviceSchema = new PredicateSchema(DEVICE);
    add(deviceSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.Device"));
    PredicateSchema locationSchema = new PredicateSchema(LOCATION);
    add(locationSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.Location"));
    PredicateSchema activitySchema = new PredicateSchema(ACTIVITY);
    add(activitySchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.Activity"));
    PredicateSchema placeSchema = new PredicateSchema(PLACE);
    add(placeSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.Place"));
    PredicateSchema personSchema = new PredicateSchema(PERSON);
    add(personSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.Person"));
    PredicateSchema eventSchema = new PredicateSchema(EVENT);
    add(eventSchema, Class.forName("au.edu.latrobe.placecomm.ontology.j2me.Event"));
    ...
    //.add(PBVC_HASEVENT, eventSchema, 0, ObjectSchema.UNLIMITED);
